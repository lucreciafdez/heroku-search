...
function (_Component) {
  ...
  function ResultsContainer() {
    ...
    return (0, _possibleConstructorReturn2.default)(this, (0, _getPrototypeOf2.default)(ResultsContainer).apply(this, arguments));
  }
  ...
  (0, _createClass2.default)(ResultsContainer, [{
    ...
    value: function render() {
      var _this$props = this.props,
          ...
          rest = (0, _objectWithoutProperties2.default)(_this$props, ["className", "clickThroughTags", "resultView", "results", "shouldTrackClickThrough", "titleField", "urlField", "view"]);
      ...
      return View(_objectSpread({
        ...
        children: results.map(function (result) {
          return _react.default.createElement(_2.Result, {
